...
public extension NSMutableAttributedString {
    ...
    public func setAtt(attrMaker: (maker: AttributeMaker)->()) -> NSMutableAttributedString {
        let maker = AttributeMaker()
        attrMaker(maker: maker)
    ...
    public class AttributeMaker {
        ...
        /**设置删除线*/
        public var deleteLineNum: Int? {
            didSet {
                if let num = self.deleteLineNum {
                    self.dictionary.updateValue(num, forKey: NSStrikethroughStyleAttributeName)
                }
            }
        }
        /**设置删除线颜色，取值为 UIColor 对象，默认值为黑色*/
        public var deleteLineColor: UIColor? {
            didSet {
        ...
        public var writingDirectionFromLeft: Bool? {
            didSet {
        ...
        public var link: NSURL? {
            didSet {
                if let link = self.link {
                    self.dictionary.updateValue(link, forKey: NSLinkAttributeName)
                }
            }
        }
